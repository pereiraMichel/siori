 ...
 * @author Debug
 */
public class RelatorioMovimento extends javax.swing.JFrame {

    /**
     * Creates new form RelatorioMovimento
     */
    public RelatorioMovimento() {
        initComponents();
        this.setAlwaysOnTop(true);
        this.ocultaLabel();
        barraProgresso.setString("A preparar o relatório...");
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Relatório de Movimento");
        ...
        barraProgresso.setString("Clique em Gerar para continuar...");
    ...
    public void barraDeProgresso(){
        barraProgresso.setString("Verificando informações...");
        try{
            for(int i=1; i < 100; i++){
                if(i == 20)
                    barraProgresso.setString("Aguardando... 20%");
                if(i == 50)
                    barraProgresso.setString("Aguardando... 50%");
                if(i == 80)
                    barraProgresso.setString("Aguardando... 80%");
                if(i == 90)
                    barraProgresso.setString("Aguardando... 90%");
                if(i == 95)
                    barraProgresso.setString("Preparando o relatório...");
                if(i == 99)
                    barraProgresso.setString("Pronto. Clique em Gerar");
                Thread.sleep(100);
            }
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        ...
        //        if(barraProgresso.isIndeterminate()){
            Relatorios rel = new Relatorios();
            rel.geraRelatorioMovimento();
            this.dispose();
            //        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioMovimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioMovimento().setVisible(true);
            }
        });
    }
